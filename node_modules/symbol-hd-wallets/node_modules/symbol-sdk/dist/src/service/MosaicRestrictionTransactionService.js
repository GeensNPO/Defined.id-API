...
class MosaicRestrictionTransactionService {
    ...
    getAddressRestrictionEntry(mosaicId, restrictionKey, targetAddress) {
        return this.restrictionMosaicRepository.searchMosaicRestrictions({ mosaicId, targetAddress }).pipe(operators_1.map((mosaicRestriction) => {
            return mosaicRestriction.data[0].restrictions.get(restrictionKey.toString());
    ...
    getGlobalRestrictionEntry(mosaicId, restrictionKey) {
        return this.restrictionMosaicRepository.searchMosaicRestrictions({ mosaicId }).pipe(operators_1.map((mosaicRestrictionPage) => {
            const globalRestriction = mosaicRestrictionPage.data.find((r) => r instanceof MosaicGlobalRestriction_1.MosaicGlobalRestriction);
