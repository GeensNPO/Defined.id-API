 ...
 */
export declare class AccountKeyLinkTransaction extends Transaction {
    /**
     ...
     */
    static create(deadline: Deadline, linkedPublicKey: string, linkAction: LinkAction, networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): AccountKeyLinkTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
