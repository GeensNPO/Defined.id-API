...
export declare class MosaicAddressRestrictionTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, mosaicId: UnresolvedMosaicId, restrictionKey: UInt64, targetAddress: UnresolvedAddress, newRestrictionValue: UInt64, networkType: NetworkType, previousRestrictionValue?: UInt64, maxFee?: UInt64, signature?: string, signer?: PublicAccount): MosaicAddressRestrictionTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
