...
export declare class TransferTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, recipientAddress: UnresolvedAddress, mosaics: Mosaic[], message: Message, networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): TransferTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
