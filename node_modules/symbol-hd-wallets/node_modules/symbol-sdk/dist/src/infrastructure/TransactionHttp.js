...
class TransactionHttp extends Http_1.Http {
    ...
    searchTransactionByGroup(criteria) {
        ...
        switch (criteria.group) {
            case TransactionGroup_1.TransactionGroup.Confirmed:
                return this.transactionRoutesApi.searchConfirmedTransactions((_a = criteria.address) === null || _a === void 0 ? void 0 : _a.plain(), (_b = criteria.recipientAddress) === null || _b === void 0 ? void 0 : _b.plain(), criteria.signerPublicKey, (_c = criteria.height) === null || _c === void 0 ? void 0 : _c.toString(), (_d = criteria.fromHeight) === null || _d === void 0 ? void 0 : _d.toString(), (_e = criteria.toHeight) === null || _e === void 0 ? void 0 : _e.toString(), (_f = criteria.type) === null || _f === void 0 ? void 0 : _f.map((type) => type.valueOf()), criteria.embedded, criteria.pageSize, criteria.pageNumber, criteria.offset, DtoMapping_1.DtoMapping.mapEnum(criteria.order));
            case TransactionGroup_1.TransactionGroup.Unconfirmed:
                return this.transactionRoutesApi.searchUnconfirmedTransactions((_g = criteria.address) === null || _g === void 0 ? void 0 : _g.plain(), (_h = criteria.recipientAddress) === null || _h === void 0 ? void 0 : _h.plain(), criteria.signerPublicKey, (_j = criteria.height) === null || _j === void 0 ? void 0 : _j.toString(), (_k = criteria.fromHeight) === null || _k === void 0 ? void 0 : _k.toString(), (_l = criteria.toHeight) === null || _l === void 0 ? void 0 : _l.toString(), (_m = criteria.type) === null || _m === void 0 ? void 0 : _m.map((type) => type.valueOf()), criteria.embedded, criteria.pageSize, criteria.pageNumber, criteria.offset, DtoMapping_1.DtoMapping.mapEnum(criteria.order));
            case TransactionGroup_1.TransactionGroup.Partial:
                return this.transactionRoutesApi.searchPartialTransactions((_o = criteria.address) === null || _o === void 0 ? void 0 : _o.plain(), (_p = criteria.recipientAddress) === null || _p === void 0 ? void 0 : _p.plain(), criteria.signerPublicKey, (_q = criteria.height) === null || _q === void 0 ? void 0 : _q.toString(), (_r = criteria.fromHeight) === null || _r === void 0 ? void 0 : _r.toString(), (_s = criteria.toHeight) === null || _s === void 0 ? void 0 : _s.toString(), (_t = criteria.type) === null || _t === void 0 ? void 0 : _t.map((type) => type.valueOf()), criteria.embedded, criteria.pageSize, criteria.pageNumber, criteria.offset, DtoMapping_1.DtoMapping.mapEnum(criteria.order));
        }
    }
}
