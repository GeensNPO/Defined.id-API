...
class HashLockHttp extends Http_1.Http {
    ...
    constructor(url, fetchApi) {
        super(url, fetchApi);
        this.hashLockRoutesApi = new symbol_openapi_typescript_fetch_client_1.HashLockRoutesApi(this.config());
    }
    /**
     ...
     */
    search(criteria) {
        return this.call(this.hashLockRoutesApi.searchHashLock(criteria.address.plain(), criteria.pageSize, criteria.pageNumber, criteria.offset, DtoMapping_1.DtoMapping.mapEnum(criteria.order)), (body) => super.toPage(body.pagination, body.data, this.toHashLockInfo));
    }
    /**
     ...
     */
    toHashLockInfo(dto) {
        return new HashLockInfo_1.HashLockInfo(dto.id, Address_1.Address.createFromEncoded(dto.lock.ownerAddress), new MosaicId_1.MosaicId(dto.lock.mosaicId), UInt64_1.UInt64.fromNumericString(dto.lock.amount), UInt64_1.UInt64.fromNumericString(dto.lock.endHeight), dto.lock.status, dto.lock.hash);
    }
}
