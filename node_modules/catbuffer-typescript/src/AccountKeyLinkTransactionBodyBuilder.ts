...
export class AccountKeyLinkTransactionBodyBuilder {
    /** Linked public key. */
     ...
     */
    public constructor(linkedPublicKey: KeyDto,  linkAction: LinkActionDto) {
     ...
     */
    public static loadFromBinary(payload: Uint8Array): AccountKeyLinkTransactionBodyBuilder {
        const byteArray = Array.from(payload);
        const linkedPublicKey = KeyDto.loadFromBinary(Uint8Array.from(byteArray));
