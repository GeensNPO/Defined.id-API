...
export class EmbeddedMosaicMetadataTransactionBuilder extends EmbeddedTransactionBuilder {
    ...
    public constructor(signerPublicKey: KeyDto,  version: number,  network: NetworkTypeDto,  type: EntityTypeDto,  targetAddress: UnresolvedAddressDto,  scopedMetadataKey: number[],  targetMosaicId: UnresolvedMosaicIdDto,  valueSizeDelta: number,  value: Uint8Array) {
