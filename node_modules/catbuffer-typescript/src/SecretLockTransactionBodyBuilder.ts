...
export class SecretLockTransactionBodyBuilder {
    ...
    public constructor(recipientAddress: UnresolvedAddressDto,  secret: Hash256Dto,  mosaic: UnresolvedMosaicBuilder,  duration: BlockDurationDto,  hashAlgorithm: LockHashAlgorithmDto) {
