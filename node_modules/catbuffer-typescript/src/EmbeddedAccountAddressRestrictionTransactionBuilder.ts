...
export class EmbeddedAccountAddressRestrictionTransactionBuilder extends EmbeddedTransactionBuilder {
    ...
    public constructor(signerPublicKey: KeyDto,  version: number,  network: NetworkTypeDto,  type: EntityTypeDto,  restrictionFlags: AccountRestrictionFlagsDto,  restrictionAdditions: UnresolvedAddressDto[],  restrictionDeletions: UnresolvedAddressDto[]) {
