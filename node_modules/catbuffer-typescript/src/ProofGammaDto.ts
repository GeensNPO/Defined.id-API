...
/** Proof gamma. */
export class ProofGammaDto {
    /** Proof gamma. */
    proofGamma: Uint8Array;
    ...
    public static loadFromBinary(payload: Uint8Array): ProofGammaDto {
        ...
        const proofGamma = GeneratorUtils.getBytes(Uint8Array.from(byteArray), 32);
     ...
     * @return Proof gamma.
     */
    public getProofGamma(): Uint8Array {
    ...
    public serialize(): Uint8Array {
        ...
        newArray = GeneratorUtils.concatTypedArrays(newArray, this.proofGamma);
        return newArray;
    }
}
