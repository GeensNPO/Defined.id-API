...
export class NodeKeyLinkTransactionBuilder extends TransactionBuilder {
    /** Node key link transaction body. */
    nodeKeyLinkTransactionBody: NodeKeyLinkTransactionBodyBuilder;
    ...
    public constructor(signature: SignatureDto,  signerPublicKey: KeyDto,  version: number,  network: NetworkTypeDto,  type: EntityTypeDto,  fee: AmountDto,  deadline: TimestampDto,  linkedPublicKey: KeyDto,  linkAction: LinkActionDto) {
    ...
    public static loadFromBinary(payload: Uint8Array): NodeKeyLinkTransactionBuilder {
        ...
        const nodeKeyLinkTransactionBody = NodeKeyLinkTransactionBodyBuilder.loadFromBinary(Uint8Array.from(byteArray));
     ...
     */
    public getLinkedPublicKey(): KeyDto {
