...
export class MosaicMetadataTransactionBodyBuilder {
    ...
    public constructor(targetAddress: UnresolvedAddressDto,  scopedMetadataKey: number[],  targetMosaicId: UnresolvedMosaicIdDto,  valueSizeDelta: number,  value: Uint8Array) {
