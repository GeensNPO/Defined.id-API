...
export class NamespaceRoutesApi extends runtime.BaseAPI {
     ...
     */
    async getAccountsNamesRaw(requestParameters: GetAccountsNamesRequest): Promise<runtime.ApiResponse<AccountsNamesDTO>> {
     ...
     * Get readable names for a set of accountIds
     */
    async getAccountsNames(addresses: Addresses): Promise<AccountsNamesDTO> {
        const response = await this.getAccountsNamesRaw({ addresses: addresses });
     ...
     */
    async getMosaicsNamesRaw(requestParameters: GetMosaicsNamesRequest): Promise<runtime.ApiResponse<MosaicsNamesDTO>> {
     ...
     * Get readable names for a set of mosaics
     */
    async getMosaicsNames(mosaicIds: MosaicIds): Promise<MosaicsNamesDTO> {
        const response = await this.getMosaicsNamesRaw({ mosaicIds: mosaicIds });
        return await response.value();
    }
     ...
     */
    async getNamespaceRaw(requestParameters: GetNamespaceRequest): Promise<runtime.ApiResponse<NamespaceInfoDTO>> {
     ...
     * Get namespace information
     */
    async getNamespace(namespaceId: string): Promise<NamespaceInfoDTO> {
        const response = await this.getNamespaceRaw({ namespaceId: namespaceId });
        return await response.value();
    }
     ...
     */
    async getNamespacesNamesRaw(requestParameters: GetNamespacesNamesRequest): Promise<runtime.ApiResponse<Array<NamespaceNameDTO>>> {
     ...
     * Get readable names for a set of namespaces
     */
    async getNamespacesNames(namespaceIds: NamespaceIds): Promise<Array<NamespaceNameDTO>> {
        const response = await this.getNamespacesNamesRaw({ namespaceIds: namespaceIds });
        return await response.value();
    }
     ...
     * Search namespaces
     */
    async searchNamespacesRaw(requestParameters: SearchNamespacesRequest): Promise<runtime.ApiResponse<NamespacePage>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Search namespaces
     */
    async searchNamespaces(ownerAddress?: string, registrationType?: NamespaceRegistrationTypeEnum, level0?: string, aliasType?: AliasTypeEnum, pageSize?: number, pageNumber?: number, offset?: string, order?: Order): Promise<NamespacePage> {
        const response = await this.searchNamespacesRaw({ ownerAddress: ownerAddress, registrationType: registrationType, level0: level0, aliasType: aliasType, pageSize: pageSize, pageNumber: pageNumber, offset: offset, order: order });
        return await response.value();
    }
