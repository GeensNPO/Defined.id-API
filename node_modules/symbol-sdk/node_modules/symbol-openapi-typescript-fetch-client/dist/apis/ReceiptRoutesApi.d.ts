...
export declare class ReceiptRoutesApi extends runtime.BaseAPI {
     ...
     * Search transaction statements
     */
    searchReceipts(height?: string, receiptType?: Array<ReceiptTypeEnum>, recipientAddress?: string, senderAddress?: string, targetAddress?: string, artifactId?: string, pageSize?: number, pageNumber?: number, offset?: string, order?: Order): Promise<TransactionStatementPage>;
}
