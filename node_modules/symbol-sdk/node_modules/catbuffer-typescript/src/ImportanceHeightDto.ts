...
/** Importance height. */
export class ImportanceHeightDto {
    /** Importance height. */
    ...
    public static loadFromBinary(payload: Uint8Array): ImportanceHeightDto {
        ...
        const importanceHeight = GeneratorUtils.bufferToUint64(GeneratorUtils.getBytes(Uint8Array.from(byteArray), 8));
    ...
    public serialize(): Uint8Array {
        ...
        const importanceHeightBytes = GeneratorUtils.uint64ToBuffer(this.getImportanceHeight());
        newArray = GeneratorUtils.concatTypedArrays(newArray, importanceHeightBytes);
        return newArray;
    }
}
