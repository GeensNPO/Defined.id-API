...
export class EmbeddedAccountOperationRestrictionTransactionBuilder extends EmbeddedTransactionBuilder {
    ...
    public constructor(signerPublicKey: KeyDto,  version: number,  network: NetworkTypeDto,  type: EntityTypeDto,  restrictionFlags: AccountRestrictionFlagsDto,  restrictionAdditions: number[],  restrictionDeletions: number[]) {
