...
export class MosaicDefinitionTransactionBuilder extends TransactionBuilder {
    ...
    public constructor(signature: SignatureDto,  signerPublicKey: KeyDto,  version: number,  network: NetworkTypeDto,  type: EntityTypeDto,  fee: AmountDto,  deadline: TimestampDto,  id: MosaicIdDto,  duration: BlockDurationDto,  nonce: MosaicNonceDto,  flags: MosaicFlagsDto,  divisibility: number) {
