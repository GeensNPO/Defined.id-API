...
export class EmbeddedVrfKeyLinkTransactionBuilder extends EmbeddedTransactionBuilder {
    ...
    public constructor(signerPublicKey: KeyDto,  version: number,  network: NetworkTypeDto,  type: EntityTypeDto,  linkedPublicKey: KeyDto,  linkAction: LinkActionDto) {
    ...
    public static loadFromBinary(payload: Uint8Array): EmbeddedVrfKeyLinkTransactionBuilder {
        ...
        const vrfKeyLinkTransactionBody = VrfKeyLinkTransactionBodyBuilder.loadFromBinary(Uint8Array.from(byteArray));
