...
/** Pinned voting key. */
export class PinnedVotingKeyBuilder {
    /** Voting key. */
     ...
     */
    public constructor(votingKey: VotingKeyDto,  startPoint: FinalizationPointDto,  endPoint: FinalizationPointDto) {
    ...
    public static loadFromBinary(payload: Uint8Array): PinnedVotingKeyBuilder {
        ...
        const votingKey = VotingKeyDto.loadFromBinary(Uint8Array.from(byteArray));
     ...
     * @return Voting key.
     */
    public getVotingKey(): VotingKeyDto {
