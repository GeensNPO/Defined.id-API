...
export class AccountAddressRestrictionTransactionBuilder extends TransactionBuilder {
    ...
    public constructor(signature: SignatureDto,  signerPublicKey: KeyDto,  version: number,  network: NetworkTypeDto,  type: EntityTypeDto,  fee: AmountDto,  deadline: TimestampDto,  restrictionFlags: AccountRestrictionFlagsDto,  restrictionAdditions: UnresolvedAddressDto[],  restrictionDeletions: UnresolvedAddressDto[]) {
