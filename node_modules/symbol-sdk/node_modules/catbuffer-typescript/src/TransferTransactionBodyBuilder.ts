...
export class TransferTransactionBodyBuilder {
    ...
    /** Reserved padding to align mosaics on 8-byte boundary. */
    transferTransactionBody_Reserved2: number;
    /** Attached mosaics. */
    ...
    public static loadFromBinary(payload: Uint8Array): TransferTransactionBodyBuilder {
        ...
        // tslint:disable-next-line: max-line-length
        const transferTransactionBody_Reserved2 = GeneratorUtils.bufferToUint(GeneratorUtils.getBytes(Uint8Array.from(byteArray), 1));
        byteArray.splice(0, 1);
        const mosaics: UnresolvedMosaicBuilder[] = [];
        for (let i = 0; i < (Array.isArray(mosaicsCount) ? GeneratorUtils.compact(mosaicsCount) : mosaicsCount); i++) {
     ...
     * @return Reserved padding to align mosaics on 8-byte boundary.
     */
    public getTransferTransactionBody_Reserved2(): number {
    ...
    public serialize(): Uint8Array {
        ...
        // tslint:disable-next-line: max-line-length
        const transferTransactionBody_Reserved2Bytes = GeneratorUtils.uintToBuffer(this.getTransferTransactionBody_Reserved2(), 1);
