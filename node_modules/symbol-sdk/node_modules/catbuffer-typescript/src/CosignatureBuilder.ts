...
export class CosignatureBuilder {
     ...
     */
    public constructor(version: number[],  signerPublicKey: KeyDto,  signature: SignatureDto) {
    ...
    public static loadFromBinary(payload: Uint8Array): CosignatureBuilder {
        ...
        const version = GeneratorUtils.bufferToUint64(GeneratorUtils.getBytes(Uint8Array.from(byteArray), 8));
