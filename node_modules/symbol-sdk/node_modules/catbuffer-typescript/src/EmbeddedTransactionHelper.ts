    ...
    public static loadFromBinary(bytes: Uint8Array): EmbeddedTransactionBuilder {
        ...
        switch (header.getType()) {
            ...
            case EntityTypeDto.ACCOUNT_KEY_LINK_TRANSACTION_BUILDER:
                return EmbeddedAccountKeyLinkTransactionBuilder.loadFromBinary(bytes);
            case EntityTypeDto.NODE_KEY_LINK_TRANSACTION_BUILDER:
                return EmbeddedNodeKeyLinkTransactionBuilder.loadFromBinary(bytes);
            case EntityTypeDto.VOTING_KEY_LINK_TRANSACTION_BUILDER:
                return EmbeddedVotingKeyLinkTransactionBuilder.loadFromBinary(bytes);
            case EntityTypeDto.VRF_KEY_LINK_TRANSACTION_BUILDER:
                return EmbeddedVrfKeyLinkTransactionBuilder.loadFromBinary(bytes);
