...
export class AccountRestrictionMosaicValueBuilder {
    /** Restriction values. */
     ...
     */
    public constructor(restrictionValues: MosaicIdDto[]) {
    ...
    public static loadFromBinary(payload: Uint8Array): AccountRestrictionMosaicValueBuilder {
        ...
        const restrictionValues: MosaicIdDto[] = [];
        ...
        for (let i = 0; i < (Array.isArray(restrictionValuesCount) ? GeneratorUtils.compact(restrictionValuesCount) : restrictionValuesCount); i++) {
            const item = MosaicIdDto.loadFromBinary(Uint8Array.from(byteArray));
     ...
     */
    public getRestrictionValues(): MosaicIdDto[] {
