export declare class RawArray {
     ...
     */
    static uint8View: (input: any) => Uint8Array;
    /**
     ...
     */
    static copy: (dest: any, src: any, numElementsToCopy?: any, destOffset?: number, srcOffset?: number) => any;
    /**
     * Determines whether or not an array is zero-filled.
     * @param {Array} array The array to check.
     * @returns {boolean} true if the array is zero-filled, false otherwise.
     */
    static isZeroFilled: (array: any) => boolean;
    /**
