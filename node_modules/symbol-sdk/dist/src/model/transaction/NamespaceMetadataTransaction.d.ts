...
export declare class NamespaceMetadataTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, targetAddress: UnresolvedAddress, scopedMetadataKey: UInt64, targetNamespaceId: NamespaceId, valueSizeDelta: number, value: string, networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): NamespaceMetadataTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
