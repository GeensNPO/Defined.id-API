...
exports.HashLockInfoDTOToJSON = exports.HashLockInfoDTOFromJSONTyped = exports.HashLockInfoDTOFromJSON = void 0;
function HashLockInfoDTOFromJSON(json) {
...
function HashLockInfoDTOToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
