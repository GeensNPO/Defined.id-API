...
class RestrictionMosaicRoutesApi extends runtime.BaseAPI {
     ...
     */
    searchMosaicRestrictionRaw(requestParameters) {
     ...
     * Search mosaic restrictions
     */
    searchMosaicRestriction(mosaicId, entryType, targetAddress, pageSize, pageNumber, offset, order) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.searchMosaicRestrictionRaw({ mosaicId: mosaicId, entryType: entryType, targetAddress: targetAddress, pageSize: pageSize, pageNumber: pageNumber, offset: offset, order: order });
