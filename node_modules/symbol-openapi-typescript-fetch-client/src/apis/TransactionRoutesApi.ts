...
export class TransactionRoutesApi extends runtime.BaseAPI {
     ...
     * Search confirmed transactions
     */
    async searchConfirmedTransactions(address?: string, recipientAddress?: string, signerPublicKey?: string, height?: string, fromHeight?: string, toHeight?: string, type?: Array<TransactionTypeEnum>, embedded?: boolean, pageSize?: number, pageNumber?: number, offset?: string, order?: Order): Promise<TransactionPage> {
        const response = await this.searchConfirmedTransactionsRaw({ address: address, recipientAddress: recipientAddress, signerPublicKey: signerPublicKey, height: height, fromHeight: fromHeight, toHeight: toHeight, type: type, embedded: embedded, pageSize: pageSize, pageNumber: pageNumber, offset: offset, order: order });
        return await response.value();
    }
     ...
     * Search partial transactions
     */
    async searchPartialTransactions(address?: string, recipientAddress?: string, signerPublicKey?: string, height?: string, fromHeight?: string, toHeight?: string, type?: Array<TransactionTypeEnum>, embedded?: boolean, pageSize?: number, pageNumber?: number, offset?: string, order?: Order): Promise<TransactionPage> {
        const response = await this.searchPartialTransactionsRaw({ address: address, recipientAddress: recipientAddress, signerPublicKey: signerPublicKey, height: height, fromHeight: fromHeight, toHeight: toHeight, type: type, embedded: embedded, pageSize: pageSize, pageNumber: pageNumber, offset: offset, order: order });
        return await response.value();
    }
     ...
     * Search unconfirmed transactions
     */
    async searchUnconfirmedTransactions(address?: string, recipientAddress?: string, signerPublicKey?: string, height?: string, fromHeight?: string, toHeight?: string, type?: Array<TransactionTypeEnum>, embedded?: boolean, pageSize?: number, pageNumber?: number, offset?: string, order?: Order): Promise<TransactionPage> {
        const response = await this.searchUnconfirmedTransactionsRaw({ address: address, recipientAddress: recipientAddress, signerPublicKey: signerPublicKey, height: height, fromHeight: fromHeight, toHeight: toHeight, type: type, embedded: embedded, pageSize: pageSize, pageNumber: pageNumber, offset: offset, order: order });
        return await response.value();
    }
